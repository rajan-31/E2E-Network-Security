...
kubectl delete deployment backend-deployment frontend-deployment; kubectl delete service backend-service frontend-service; kubectl delete hpa my-app-hpa;
```